...
class UNet(nn.Module):
    def __init__(self):
        ...
        self.conv_block2 = ConvBlock(32, 32, num_group=8)
        self.down_block2 = DownBlock(32, 32, num_group=8)
        self.conv_block3 = ConvBlock(32, 64, num_group=16)
        self.down_block3 = DownBlock(64, 64, num_group=16)
        self.conv_block4 = ConvBlock(64, 64, num_group=16)
        self.down_block4 = DownBlock(64, 64, num_group=16)
        self.conv_block5 = ConvBlock(64, 128, num_group=32)
        self.down_block5 = DownBlock(128, 128, num_group=32)
        
        
        self.up_block1 = UpBlock(128, 128, num_group=32)
        self.conv_block6 = ConvBlock(128, 64, num_group=16)
        self.up_block2 = UpBlock(64, 64, num_group=16)
        self.conv_block7 = ConvBlock(64, 64, num_group=16)
        self.up_block3 = UpBlock(64, 32, num_group=8)
        self.conv_block8 = ConvBlock(32, 32, num_group=8)
        self.up_block4 = UpBlock(32, 32, num_group=8)
        self.conv_block9 = ConvBlock(32, 32, num_group=8)
        self.up_block5 = UpBlock(32, 32, num_group=8)
        self.conv_block10 = ConvBlock(32, 1, num_group=1)
        self.act = nn.SiLU()
